...
import com.qcl.request.OrderReq;
...
public class WxOrderController {
    ...
    public ResultVO<Map<String, String>> create(@Valid OrderReq orderReq,
        ...
        orderBean.setBuyerGreen (orderReq.getGreen());
        orderBean.setBuyerTaste(orderReq.getTaste());
        orderBean.setBuyerDateTime(orderReq.getDateTime());
        orderBean.setBuyerRemarks(orderReq.getRemarks());
        orderBean.setAdminId(Integer.valueOf(orderReq.getAdminId()));
