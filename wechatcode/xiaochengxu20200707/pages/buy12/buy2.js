...
Page({
  ...
  //  console.log("传入的桌号", tableNum)
    ...
    wx.request({
      ...
      data: {
        searchKey: searchKey,
        adminId: '12' // 这里的currentAdminId应该是当前商家的adminId 
      },
      success(res) {
  ...
  /* 
    ...
    let suserInfo = app.globalData.suserInfo;
    if (!suserInfo || !suserInfo.nickName) {
      wx.showModal({
        title: '请登录',
        content: '请到个人中心登录',
        showCancel: false, //去掉取消按钮
    ...
    wx.navigateTo({
      url: '../confirmOrder1/confirmOrder1?tableNum=' + 1
      //tableNum
    })
  },
